    ...
    <div class="sidebar">
      ...
      <nav class="mt-5">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/report/myReports" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/employeerequest/create" class="nav-link ">
              <i class="nav-icon fas fa-edit"></i>
              <p>Add Request</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="/employeerequest/myRequests" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
               My Requests
              </p>
          ...
          @if(auth()->user()->job_title === 'Account Manager')<li class="nav-item">
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Distinct Digital Media</b> </a>
    </div>
    <div class="card-body">
  ...
  @endif
      ...
      <p class="mb-0">
        <a href="/register" class="text-center">Register a new Staff</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
